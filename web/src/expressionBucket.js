 ...
 * mirrors worker/_shared/expression-bucket.js (not imported — separate bundle)
 * so the worker (audio prosody) and web (visual CSS) sides never disagree
 * about what a given freeform tag means. Keep the two ALIASES tables in sync
 * when editing either.
 */
 ...
 *  canonical buckets. Exact match first, then a substring scan, then "normal". */
